  ...
  return (
    <div className="registration_container">
      ...
      <header className="registration_header">
        <div className="registration_logoContainer">
          <img src={logo} alt="logo" />
        </div>
        <nav className="registration_navLinks">
          <Link to="/" className="registration_navLink">
            होम
          </Link>
          <Link to="/User" className="registration_navLink">
            वापरकर्ता
          </Link>
        </nav>
      </header>
        ...
        <div className="registration_content">
          ...
          <form className="registration_grid" onSubmit={handleSubmit}>
            ...
            <div className="registration_form-group full-width">
              ...
              <p className="registration_option">
                आधीपासूनच खाते आहे?{" "}
                <Link to={`/Login/${role}`}>लॉग इन करा</Link>
              </p>
            </div>
          </form>
