...
const MemberManagement = () => {
  ...
  const modules = [
    {
      title: "सभासद नोंदणी",
      description: "नवीन सभासद नोंदणी करा",
      icon: <FaUserPlus size={30} color="#2ecc71" />,
      path: "/Admin/Dashboard/Member/Register",
    },
    {
      title: "सभासद मंजुरी",
      description: "नोंदणीकृत सभासद तपासणी व मंजुरी करा",
      icon: <FaUserCheck size={30} color="#3498db" />,
      path: "/Admin/Dashboard/Member/Approval",
    },
    {
      title: "सभासद यादी",
      description: "सर्व सभासद यादी पहा",
      icon: <FaUsers size={30} color="#e67e22" />,
      path: "/Admin/Dashboard/Member/List",
    },
  ];
    ...
    <div className="admin-dashboard-container">
      <div className="location_header_row">
        ...
        <div className="admin-dashboard-header">
          <h2 className="admin-dashboard-title">सभासद व्यवस्थापन</h2>
          <p className="admin-dashboard-subtitle">
            सभासद प्रक्रिया नियंत्रित करा
          </p>
        </div>
      </div>
